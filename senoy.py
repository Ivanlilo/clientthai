...
cl = LINETCR.LINE()
cl.login(token="EmN8o9kdex9S6ARbqjFc.swqqqRaG2mn24/6HhYz9la.DV2Bnga7ANNtGTdaFzDuLkVZZHMLmktTbL/Nny0CL40=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Emkgipk2ep6rNloFesUe.limXL6+vp80bMJRSiFdI+G.ba1zikh/RcnkyKuESZd1Ub/0jspMzGZvnNGoT2rFF9U=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmKb49hdcrUwZ2WPC4c7.1rScLzAA+Y5i0DD3zWAobW.Jkzg+u5jOYEoOUD7JiQp+BKoGbYhcM42ImKCpPUsWq4=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EmNxJwXkArrjHT80lG6f.fLWZ3U21X5xAjGPtE9UapW.Jw4EsenhjXjgqDlHe2xA4Kl7R5L5efD9wfWF9yiVvS0=")
kc.loginResult()
...
🚀 All mid 🔥
🚀 All me 🔥
🚀 Myname:  (ganti nama for my contact)🔥
🚀 Mystatus: (update status my account) 🔥
🚀 Status1:  (update status for kicker)🔥
🚀 Name1:  (ganti nama for kicker) 🔥
🚀 TL: 🔥
🚀 Bot 🔥
🚀 Spam @ 🔥
🚀 Mid @ 🔥
...
💥 All or Guard = Call Assist 💥
💥 Pulang = Bye Assist 💥
💥 Kill = kick the blacklist 💥
💥 Nk 「@」] 💥
💥 Ban = Share Contact 💥
💥 Unban = Share Contact 💥
💥 Banlist︎ 💥
...
admin=["u49641042b020d8c376e3eea11f267d2c"]
creator=["u49641042b020d8c376e3eea11f267d2c"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    try:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Done Status👉 " + string + "👈")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki.updateProfile(profile)
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Name1👉 " + string + "👈")
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                cl.sendText(msg.to,mid)
            elif "Rf1 mid" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Rf2 mid" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Rf3 mid" == msg.text:
                kc.sendText(msg.to,Cmid)
                ...
                if wait["clock"] == True:
            ...
            elif msg.text == "Lurkon":
                    cl.sendText(msg.to, "LurnOn°")
                    try:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "== 💡Bakekok Sider by RFU 💡== %s\nthat's it\n\nPeople who have ignored reads\n%scctv wkwk. ♪\n\nReading point creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       kk.sendText(g.mid,"Sorry")
                       ki.sendText(g.mid,"Sorry")  
                       kc.sendText(g.mid,"Sorry")
                       cl.sendText(msg.to, "Wkwkk")
                       print " Spammed !"
                       print " Sorry !"
#-----------------------------------------------------------------
            elif "Bot" == msg.text:
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"Not found Rfu")
                        kk.sendText(msg.to,"Not found Rfu")
                        kc.sendText(msg.to,"Not found Rfu")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes Rfu")
                                ki.sendText(msg.to,"Succes Rfu")
                                kk.sendText(msg.to,"Succes Rfu")
                                kc.sendText(msg.to,"Succes Rfu")
                            except:
                                ki.sendText(msg.to,"Error")
...
#----------------------------------------------------------------
              ...
              if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Sukses clear all ban no")
#-----------------------------------------------
            elif msg.text in ["Creator"]:
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u49641042b020d8c376e3eea11f267d2c"}
					cl.sendMessage(msg)
#-----------------------------------------------
            elif msg.text in ["Test"]:
                ki.sendText(msg.to,"Ok RFU 􀨁􀄻double thumbs up􏿿")
                kk.sendText(msg.to,"Ok RFU 􀨁􀄻double thumbs up􏿿")
                kc.sendText(msg.to,"Ok RFU 􀨁􀄻double thumbs up􏿿")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"RFU1")
                kk.sendText(msg.to,"RFU2")
                kc.sendText(msg.to,"RFU3")
#-----------------------------------------------
...
#------------------------------------------------------------------
                    ...
                    start = time.time()
                    cl.sendText(msg.to, "Becak 1000cc")
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
#------------------------------------------------------------------
            elif msg.text == "sTime":
                    start = time.time()
                    cl.sendText(msg.to, "Starting stest..")
                    elapsed_time = time.time() - start
                    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
#============Double_Kick========#
