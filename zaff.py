...
cl = LINETCR.LINE()
cl.login(token="EmTmfw0as2B3J6RAoN17.5hCWggWiMLDLwL0DnLVh5W.vc6lz1WX7pWdlVuZ7yjGeJSHAVc8Op3tljS/t4SMn9k=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmrWgpsVymr0g52suOdb.DrJoWxVb7eqUpciGCXEDMW.bBHsMl6F+/TM0jaRhvQFCzfiCoY09QjWhltNAVAWma4=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmmbAduQq8oU429zIWea.1fhBnk5cf/2WsxFUl24rYG.DGXr5d2kvLdGznQc1DpJgQsBI4QF2a9Ucr/Cwa9oUfM=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Emp6VqcL7GB1EZsjShU6.n4h+W3JIh/q7fE/nr0dW1G.w+3g8yBsE5nSVD9IZ/LBwE8nu/ChL3rXIa+JAkmYMRA=")
kc.loginResult()

ks = LINETCR.LINE()
ks.login(token="Em33FyghKvAiZrHXPDia.PZmlbkhpfnU3q50CJjBRcG.BMGoXjYvIAixcEP6bnCiGE5JQRbi5memTbqn3lRzlPQ=")
ks.loginResult()

ka = LINETCR.LINE()
ka.login(token="Emzbslia5IV4XhqKFG84.fgL3/DQrFk3wD9GG5uKpPa.9MWaDFDuFNy1zyuLe+7tdVjWMbQk4vKtSdGIb0lhbbg=")
ka.loginResult()
...
🚀 Name2:  (ganti nama for kicker) 🔥
🚀 Name3:  (ganti nama for kicker) 🔥
🚀 Name4:  (ganti nama for kicker) 🔥
🚀 Name5:  (ganti nama for kicker) 🔥
🚀 TL: 🔥
🚀 Bot 🔥
🚀 Spam @ 🔥
🚀 Ban @ 🔥
...
admin=["ue47730186c089a57655a5d1d365bc7e7"]
creator=["ue47730186c089a57655a5d1d365bc7e7"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif "Rf1 kick " in msg.text:
                midd = msg.text.replace("Cv1 kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Rf2 kick " in msg.text:
                midd = msg.text.replace("Cv2 kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Rf3 kick " in msg.text:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Name2👉 " + string + "👈")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Name3👉 " + string + "👈")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Name4👉 " + string + "👈")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Update Name5👉 " + string + "👈")
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "ue47730186c089a57655a5d1d365bc7e7"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                ks.sendText(msg.to,"RFU4")
                ka.sendText(msg.to,"RFU5")
#-----------------------------------------------
